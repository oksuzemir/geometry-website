...
class Custom_Widget extends WP_Widget {
    ...
    esc_html__( 'Renkli Kutular', 'text_domain' ), // Name
    array( 'description' => esc_html__( 'Renkli Kutular', 'text_domain' ), ) // Args
    );
    }
    /**
...
<div class="third-content-card "><div class="third-content-ikon"> <img src="wp-content/themes/geometri/img/card-icon.png" alt="Geometri İkonu" /> </div> <h2 class="third-content-title">
<?php
    if ( ! empty( $instance['title'] ) ) { ?>
        <?php echo nl2br( esc_html( $instance['title'] ) ) ?>
    </h2><div class="third-content-text">
        <?php }
    ...
    */
    ...
    <input placeholder="Başlık" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"
    ...
    <textarea type="text" rows="5" cols="20" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"
...
<?php echo esc_attr( $text ); ?>
    ...
    <input class="widefat" placeholder="/ornek-sayfa-linki" id="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>"
...
if (function_exists('register_sidebar'))
{
      ...
      register_sidebar(array(
        'name' => __('Renkli Kutular', 'html5blank'),
        'description' => __('Renkli Kutular', 'html5blank'),
        'id' => 'renkli-kutular',
